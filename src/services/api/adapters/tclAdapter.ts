...
export function normalizeTclRealtimeLineReference(value: string): string {
...
export function createTclAdapter(realtimeConfig: CityRealtimeConfig): TransportAdapter {
